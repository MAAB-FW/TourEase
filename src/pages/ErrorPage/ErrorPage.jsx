...
const ErrorPage = () => {
    return (
        <div>
            <div className="bg-gray-100 min-h-screen p-10 gap-10 flex flex-col justify-center items-center">
                <style>
                    {`
        .emoji-404 {
            position: relative;
        ...
        `}
                ...
                <div className="text-center">
                    <svg
                        className="emoji-404 mb-6 sm:mb-0"
                    ...
                    <div className="tracking-widest">
                        <span className="text-gray-500 text-3xl sm:text-6xl block">4 0 4</span>
                ...
                <div className="text-center">
                    <Link
                        to={-1}
                        className="text-gray-500 font-mono text-lg sm:text-xl bg-gray-200 p-3 rounded-md hover:shadow-md"
                    >
                        Go back
                    </Link>
                </div>
